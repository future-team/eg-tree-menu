...
class App extends Component{
    ...
    render(){
        let self=this;
        return(<div>
            <button onClick={function(){console.log(self.refs.tm.getExpandNodes())}}>获取展开节点</button>
            ...
            <button onClick={function(){console.log(self.refs.multiTm.getSelectedNodes())}}>获取选中节点</button>
            <button onClick={function(){console.log(self.refs.multiTm.getExpandNodes())}}>获取展开节点</button>
            <TreeMenu multiSelect={true} ref='multiTm' clickCallback={function(nodeId,type,node){
                console.log(nodeId,type,node);
